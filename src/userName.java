...
public class userName extends javax.swing.JFrame {
    ...
    public userName() {
        ...
        ImageIcon icon = new ImageIcon(getClass().getResource("/images/ekran1.jpg"));
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel2);
        jLabel2.setBounds(90, 220, 290, 45);
        ...
        username_txt.setBounds(390, 230, 70, 23);
        ...
        jButton1.setBounds(290, 320, 110, 51);
        jPanel1.add(jLabel1);
...
String p = "^[a-zA-Z]{4,10}$"; // en az 4 en fazla 10 harf

Pattern r = Pattern.compile(p);
Matcher m = r.matcher(username);

if (!m.matches()) {
    JOptionPane.showMessageDialog(this, "You have to enter min. 4 max. 10 letters.", "Error", JOptionPane.ERROR_MESSAGE);
    username_txt.setText("");
} else {
    game gameFrame = new game(username); // username gönderiliyor
    gameFrame.setVisible(true);          // doğru nesne gösteriliyor
    this.setVisible(false);              // mevcut pencereyi kapat
    this.dispose();
}
