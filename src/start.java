...
public class start extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jToggleButton1.setBounds(290, 290, 120, 23);

        jToggleButton2.setText("SHOW SCORE");
        ...
        jToggleButton2.setBounds(290, 330, 117, 23);
        jPanel1.add(jLabel1);
    ...
    private void jToggleButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton2ActionPerformed
        score_table hel = new score_table();
        hel.setVisible(true);
        setVisible(false);
